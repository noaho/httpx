...
func ParseOptions() *Options {
	...
	flagSet.CreateGroup("configs", "Configurations",
		...
		flagSet.StringVarP(&options.SniName, "sni-name", "sni", "", "custom TLS SNI name (overridden by per-target explicit SNI in vhost format)"),
		...
		flagSet.BoolVar(&options.VHostInput, "vhost-input", false, "get a list of vhosts as input (using format: hostheader[optional_explicit_sni],target)"),
